...
class handDetector():
    ...
    def normalizeData(self, data):
        ...
        normalization_model = load(open('/Users/joaoangnes/Documents/Faculdade/Sistema Inteligentes/Sign-Language-Detection-using-Distances-Python/normalization.model','rb'))
